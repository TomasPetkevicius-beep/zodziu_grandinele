...
function first(){
    ...
    else if ($_POST['first'] == "rida" && $_POST['second'] == "riba" && $_POST['third'] == "žiba" && $_POST['fourth'] == "žila") {
        header("Location: /php/tomas_projektas/sixth/correct/index.php");
    }
    else { header("Location: /php/tomas_projektas/sixth/incorrect/index.php");
    }
}
    first();
 ?>
